<?php
    ...
    $bestSeller_data_fatch = [];

    $bestSelle_product_data = mysqli_query($con,  "SELECT product_master.product_name, 
                        ...
                        product_master.best_seller = 'Yes' ");
    ...
    //     $SendData = [];
    // } else {
        while ($row = mysqli_fetch_assoc($bestSelle_product_data)) {
            ...
            $bestSeller_data_fatch[] = $row;
        }

        if($bestSeller_data_fatch)
        {
            $status = "Success";
            $message = "Best Selle Product Fetched Successfully";
            $SendData = $bestSeller_data_fatch;
        }
        else {
            $status = "Not Found";
            $message = "Best Selle arrivals Product Not Found";
            $SendData = [];
        }
    // }
