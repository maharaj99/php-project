<?php
    ...
    $mostpopular_data_fatch = [];

    $most_popular_product_data = mysqli_query($con,  "SELECT product_master.product_name, 
                        ...
                        product_master.most_popular = 'Yes' ");
    ...
    //     $SendData = [];
    // } else {
        while ($row = mysqli_fetch_assoc($most_popular_product_data)) {
            ...
            $mostpopular_data_fatch[] = $row;
        }

        if($mostpopular_data_fatch)
        {
            $status = "Success";
            $message = "Most Populer Product Fetched Successfully";
            $SendData = $mostpopular_data_fatch;
        }
        else {
            $status = "Not Found";
            $message = "Most Populer Product Not Found";
            $SendData = [];
        }
    // }
