<?php
    ...
    $Newproduct_data_fatch = [];

    $new_product_data = mysqli_query($con,  "SELECT product_master.product_name, 
                        ...
                        product_master.new_arrivals = 'Yes' ");   
    ...
    //     $SendData = [];
    // } else {
        while ($row = mysqli_fetch_assoc($new_product_data)) {
              ...
              $row['wish'] = in_array($row['product_code'], $wishProductCodes) ? "Yes" : "No";
                ...
                $Newproduct_data_fatch[] = $row;
        }

        if($Newproduct_data_fatch)
        {
            $status = "Success";
            $message = "New arrivals Product Fetched Successfully";
            $SendData = $Newproduct_data_fatch;
        }
        else {
            $status = "Not Found";
            $message = "New arrivals Product Not Found";
            $SendData = [];
        }
    // }
