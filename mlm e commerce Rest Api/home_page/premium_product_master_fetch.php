<?php
    ...
    $home_product_data = mysqli_query($con, "SELECT product_master.product_name, 
            ...
            WHERE product_master.active = 'Yes' AND product_master.premium = 'Yes' AND product_master.show_in_website = 'Yes'");
    ...
    // } else {
        ...
        if ($product_data_fatch) {
                $status = "Success";
                $message = "premium Product Muster Data Fetched Successfully";
