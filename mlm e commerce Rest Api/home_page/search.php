<?php
    ...
    $searchResult = isset($postData['search_result']) ? $postData['search_result'] : null;
    ...
    $sql = "SELECT product_master.product_name,
            ...
            WHERE product_master.active = 'Yes'";


    if ($searchResult) {
        $sql .= " AND ( category_master.category like '%".$searchResult."%' OR sub_category_master.sub_category like '%".$searchResult."%' OR product_master.product_name like '%".$searchResult."%' ) ";
    }
