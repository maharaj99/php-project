<?php
    ...
    $subCategoryCode = isset($postData['sub_category_code']) ? $postData['sub_category_code'] : null;
    ...
    if ($categoryCode) {
        $sql .= " AND product_master.category_code = '$categoryCode'";
    }


    if ($subCategoryCode) {
        $sql .= " AND product_master.sub_category_code = '$subCategoryCode'";
    }
